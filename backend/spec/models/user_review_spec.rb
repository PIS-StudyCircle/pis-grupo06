...
RSpec.describe UserReview, type: :model do
  ...
  let!(:reviewer) {
    User.create!(name: "Alice", last_name: "Tutor", email: "alice@test.com", password: "12345678",
                 password_confirmation: "12345678", faculty: faculty)
  }
  let!(:reviewed) {
    User.create!(name: "Bob", last_name: "Student", email: "bob@test.com", password: "12345678",
                 password_confirmation: "12345678", faculty: faculty)
  }
