class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    ...
    add_fk_unless_exists "solid_queue_blocked_executions",  "solid_queue_jobs", column: "job_id", on_delete: :cascade
    add_fk_unless_exists "solid_queue_claimed_executions",  "solid_queue_jobs", column: "job_id", on_delete: :cascade
    add_fk_unless_exists "solid_queue_failed_executions",   "solid_queue_jobs", column: "job_id", on_delete: :cascade
    add_fk_unless_exists "solid_queue_ready_executions",    "solid_queue_jobs", column: "job_id", on_delete: :cascade
    add_fk_unless_exists "solid_queue_recurring_executions", "solid_queue_jobs", column: "job_id", on_delete: :cascade
    add_fk_unless_exists "solid_queue_scheduled_executions", "solid_queue_jobs", column: "job_id", on_delete: :cascade
  end

  private

  def add_fk_unless_exists(from_table, to_table, **opts)
    column = (opts[:column] || "#{to_table.to_s.singularize}_id").to_s
