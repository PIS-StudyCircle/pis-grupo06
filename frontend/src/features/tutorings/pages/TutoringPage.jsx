    ...
    <div className="flex flex-col ">
      <div className="flex-1 overflow-y-auto px-6 py-4 content-scroll">
        <div className="max-w-5xl mx-auto">
          ...
          {/*Intente usar los filtros de 40 formas y no está filtrando, los chicos de filtrado que me arreglen esto*/}
          <TutoringList tutorings={tutorings/*.filter(tutoring => tutoring.course.id === courseId)*/} mode={mode} loading={loading} error={error} />
