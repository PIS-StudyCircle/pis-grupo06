  ...
  describe "#perform" do
    ...
    context "cuando hay un mix de availabilities expiradas disponibles y reservadas" do
      ...
      it "elimina solo las availabilities expiradas y disponibles" do
        ...
        expect(TutoringAvailability.exists?(expired_available_1.id)).to be false
        expect(TutoringAvailability.exists?(expired_available_2.id)).to be false
      end
    end
