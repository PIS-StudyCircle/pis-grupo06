  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="mx-auto max-w-5xl p-4 md:p-8 space-y-6">
        ...
        {/* Panel inferior: Favoritas y Reseñas lado a lado */}
        <div className="flex flex-col md:flex-row md:gap-6">
          
          {/* Favoritas (izquierda) */}
          <div className="bg-white rounded-3xl shadow-xl w-full md:w-1/2 p-6 mb-6 md:mb-0">
          ...
          {/* Reseñas (derecha) */}
          <div className="bg-white text-black rounded-3xl shadow-xl w-full md:w-1/2 p-6">
            <h3 className="text-lg font-semibold mb-4 text-center text-[#001F54]">
              Mis reseñas
            </h3>
