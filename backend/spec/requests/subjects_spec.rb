...
RSpec.describe "Api::V1::Subjects", type: :request do
    ...
    let!(:course)     { Course.create!(name: "Curso Especial", code: "CE1", institute: "Instituto Especial", faculty: facultad) }
    let!(:user)       { User.create!(email: "test@example.com", password: "password", password_confirmation: "password", name: "Test", last_name: "User", faculty: facultad) }
